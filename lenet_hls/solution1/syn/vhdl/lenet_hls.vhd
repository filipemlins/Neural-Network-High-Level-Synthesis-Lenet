...
entity lenet_hls is
port (
    image_in_V_dout : IN STD_LOGIC_VECTOR (31 downto 0);
    image_in_V_empty_n : IN STD_LOGIC;
    image_in_V_read : OUT STD_LOGIC;
...
architecture behav of lenet_hls is 
    ...
    "lenet_hls,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z007sclg225-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.558000,HLS_SYN_LAT=1295474,HLS_SYN_TPT=1295475,HLS_SYN_MEM=557,HLS_SYN_DSP=32,HLS_SYN_FF=123154,HLS_SYN_LUT=32144,HLS_VERSION=2018_3}";
    ...
    signal conv1_U0_conv1_out_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal conv1_U0_conv1_out_V_write : STD_LOGIC;
    signal conv1_U0_in_V_read : STD_LOGIC;
    ...
    signal pool1_U0_out_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal pool1_U0_out_V_write : STD_LOGIC;
    signal pool1_U0_in_V_read : STD_LOGIC;
    ...
    signal conv2_U0_conv2_out_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal conv2_U0_conv2_out_V_write : STD_LOGIC;
    signal conv2_U0_in_V_read : STD_LOGIC;
    ...
    signal pool2_U0_out_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal pool2_U0_out_V_write : STD_LOGIC;
    signal pool2_U0_in_V_read : STD_LOGIC;
    ...
    signal fc1_U0_out_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal fc1_U0_out_V_write : STD_LOGIC;
    signal fc1_U0_in_V_read : STD_LOGIC;
    ...
    signal fc2_U0_out_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal fc2_U0_out_V_write : STD_LOGIC;
    signal fc2_U0_in_V_read : STD_LOGIC;
    ...
    signal fc3_U0_out_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal fc3_U0_out_V_write : STD_LOGIC;
    signal fc3_U0_in_V_read : STD_LOGIC;
    ...
    port (
        ...
        conv1_out_V_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        conv1_out_V_full_n : IN STD_LOGIC;
        conv1_out_V_write : OUT STD_LOGIC;
...
begin
    ...
    conv1_out_V_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    pool1_out_V_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    conv2_out_V_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    pool2_out_V_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    fc1_out_V_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    fc2_out_V_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    fc3_out_V_din <= fc3_U0_out_V_din;
    fc3_out_V_write <= fc3_U0_out_V_write;
    image_in_V_read <= conv1_U0_in_V_read;
