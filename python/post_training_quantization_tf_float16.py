...
from gen_weights_lene5 import save_weight_lenet
...
x = QConv2D(
    8, (4, 4), strides=(1,1),
    kernel_quantizer=quantized_bits(16,8,1),
    bias_quantizer=quantized_bits(16,8,1),
    name="conv2d_0_m")(x)
x = QActivation("quantized_relu(16,0)", name="act0_m")(x)
...
x = QConv2D(
    ...
    bias_quantizer=quantized_bits(16,8,1),
    name="conv2d_1_m")(x)
x = QActivation("quantized_relu(16,8)", name="act1_m")(x)
x = MaxPooling2D(pool_size = 2, strides = 2)(x)
x = Flatten()(x)

x = QDense(120, kernel_quantizer=quantized_bits(16,8,1),
           bias_quantizer=quantized_bits(16,8,1),
           name="dense1")(x)
x = QActivation("quantized_relu(16,8)", name="act2_m")(x)


x = QDense(84, kernel_quantizer=quantized_bits(16,8,1),
           bias_quantizer=quantized_bits(16,8,1),
           name="dense2")(x)
x = QActivation("quantized_relu(16,8)", name="act3_m")(x)

x = QDense(NB_CLASSES, kernel_quantizer=quantized_bits(16,8,1),
           bias_quantizer=quantized_bits(16,8,1),
           name="dense3")(x)
